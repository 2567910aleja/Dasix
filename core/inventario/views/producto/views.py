...
from core.inventario.forms import ProductoForm
from core.inventario.models import Producto
...
class ProductoListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('inventario:producto_create')
        context['list_url'] = reverse_lazy('inventario:producto_list')
